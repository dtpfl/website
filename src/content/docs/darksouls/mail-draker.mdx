...
This is an overview of the current [Dragon Tooth](https://darksouls.wikidot.com/dragon-tooth) and Sorcery [Dark Souls](/darksouls) [All Bosses](/all-bosses-darksouls) route. Note, that this does not include any safety strategies for people learning the route.
...
- Climb the tower and get the **[Red Tearstone Ring (RTSR)](https://darksouls.wikidot.com/red-tearstone-ring)**. Dupe a Homeward Bone.
