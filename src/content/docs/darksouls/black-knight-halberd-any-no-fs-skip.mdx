...
This is an overview of the [Black Knight Halberd (BKH)](https://darksouls.wikidot.com/black-knight-halberd) [Dark Souls](/darksouls) [Any%](/any-darksouls) route without the [Firesage Skip](/darksouls/firesage-skip). Note, that this does not include any safety strategies for people learning the route.
...
- Climb up the ladder near the drakes and grab the **[Red Tearstone Ring (RTSR)](https://darksouls.wikidot.com/red-tearstone-ring)**.
...
- Kill Lautrec of Carim (2 normal attacks), pick up the **[Ring of Favor and Protection (FAP ring)](https://darksouls.wikidot.com/ring-of-favor-and-protection)** and take the elevator to New Londo Ruins.
