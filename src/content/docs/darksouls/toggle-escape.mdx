...
- List of **Helpful Utilities**:
  ...
  - [**TKGP's DS Gadget ©**](https://github.com/JKAnderson/DS-Gadget/releases)
  - [**TKGP's DSR Gadget ©**](https://github.com/JKAnderson/DSR-Gadget/releases)
  - [**In-Game Time Livesplit PlugIn**](https://github.com/CapitaineToinon/LiveSplit.DarkSoulsIGT)
  - [**Gadgetlemage - A Tool to practice Black Knight Weapon routes**](https://github.com/CapitaineToinon/Gadgetlemage)
  - [**No-Logo mod**](/darksouls/no-logo-mod)
  - [**Reset All Stats LiveSplit plugin (Automatically reset steam achievements)**](https://github.com/CapitaineToinon/LiveSplit.ResetAllStats)
...
Alternatively, videos of a large number of glitches, exploits and many other things are featured on [**this Google doc spreadsheet**](https://docs.google.com/spreadsheets/d/1N34-ES_EQQ9-4VDm5h6NxBKtv3TdgB6q-R6Swf6engs/edit?usp=sharing).
...
- [**Blighttown Skip**](/darksouls/blighttown-skip): Allows the player to skip the area Blighttown entirely.
...
- Because of significant discrepancies in load times and framerate on all the platforms, the official run time is counted as the [In-game time](/in-game-time) (IGT). The run ends once the credits appear, meaning you have multiple options to see your final time:
  - Use the [**In-Game Time Livesplit PlugIn**](https://github.com/CapitaineToinon/LiveSplit.DarkSoulsIGT) to always be able to check your time.
...
- [Speedrun Glossary](https://www.speedrunslive.com/rules-faq/glossary/) on SpeedRunsLive
- [Dark Souls](https://en.wikipedia.org/wiki/Dark_Souls) at Wikipedia
- [Dark Souls Wikidot Wiki](https://darksouls.wikidot.com)
- [Dark Souls](https://speeddemosarchive.com/DarkSouls.html) at SpeedDemosArchive
- [Dark Souls Helpful Links](https://pastebin.com/WkfywHbd) at Pastebin, collected and maintained by Fhyber34
- [Dark Souls Leaderboards](https://www.speedrun.com/Dark_Souls) at speedrun.com
