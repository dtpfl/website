...
The **Pewdiepie Skip** is a minor skip in [Dark Souls](/darksouls) that lets the player open the locked door in [Lower Undead Burg](https://darksouls.wikidot.com/undead-burg#toc4) without first going through the dialogue with [Griggs of Vinheim](https://darksouls.wikidot.com/griggs-of-vinheim). It was originally simply called "Griggs Skip" but the well-known YouTuber PewDiePie accidentally triggered it in his Let's Play series of Dark Souls which made speedrunners name the skip after him.
