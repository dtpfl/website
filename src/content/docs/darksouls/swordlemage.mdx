...
This is an overview of the current [Black Knight Greatsword (BKGS)](https://darksouls.wikidot.com/black-knight-greatsword) and Sorcery [Dark Souls](/darksouls) [All Bosses](/all-bosses-darksouls) route.
...
- Cast Fall Control, Grab the [Red Sign Soapstone](https://darksouls.wikidot.com/red-sign-soapstone) and then [Fall_Damage_Cancel](/darksouls/fall-damage-cancel) down the stairs.
...
- **Flex** the [Red Tearstone Ring (RTSR)](https://darksouls.wikidot.com/red-tearstone-ring) using the [Equip_Slot_Manipulation](/darksouls/equip-slot-manipulation).
