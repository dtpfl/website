...
This is an overview of an easier route for [All_Bosses](/darksouls/all-bosses) that uses the [Dragon Tooth](https://darksouls.wikidot.com/dragon-tooth) and Sorcery with [Quantity_Storage](/darksouls/quantity-storage) to get to a high level and [Equip_Slot_Manipulation](/darksouls/equip-slot-manipulation) to obtain the [Red Tearstone Ring (RTSR)](https://darksouls.wikidot.com/red-tearstone-ring). Note, that this does not include any additional safety strategies for people learning the route.
