...
Livesplit can be downloaded from their website directly: [https://livesplit.org/](https://livesplit.org/) They have their own introduction/guide: [https://livesplit.org/introduction/](https://livesplit.org/introduction/)

Linux users are best off following ViRazY's guide: [https://hackmd.io/VaKWRwy8ScKjU_d-107nZw?view](https://hackmd.io/VaKWRwy8ScKjU_d-107nZw?view)
