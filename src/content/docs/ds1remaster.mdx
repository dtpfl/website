...
- [**Dropmod categories**](/ds1remaster/dropmod-categories/)**:** The same as above, but with a tool enabled that guarantees the desired outcome of a random drop.
...
- [Dark Souls Remastered Leaderboards](https://www.speedrun.com/darksoulsremastered) at speedrun.com
