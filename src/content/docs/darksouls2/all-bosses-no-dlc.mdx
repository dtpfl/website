...
The world record is 1:13:51 RTA no load by [**Stennis**](https://twitch.tv/Stennis) [VOD](https://www.youtube.com/watch?v=afpujn7p3NA). The leaderboards for this category are available [here](/darksouls2-leaderboardall-bosses-no-dlc).

## Routes

| Route | Estimated possible time | Current Record | Runner | VOD |
|-------|------------------------|----------------|---------|-----|
| [Hexes](https://pastebin.com/4Y3qyKQ7) | 1:08:00 | 1:13:51 | [Stennis](//twitch.tv/Stennis) | [VOD](https://www.youtube.com/watch?v=afpujn7p3NA) |
| [Maclemage](https://wiki.speedsouls.com/Maclemage) | 1:08:00 | 1:11:18 | [Stennis](//twitch.tv/Stennis) | [VOD](https://www.youtube.com/watch?v=_SJ8baUoo68&feature=emb_title) |
...
- **Defeating a boss**: To successfully defeat a boss you must kill them and stay in the boss room long enough to get any kind of boss reward. If you die before receiving the rewards your victory doesn't count as you don't get the boss rewards while dead. Also, if you [Homeward Bone](https://darksouls.wikidot.com/homeward-bone) or [Darksign](https://darksouls.wikidot.com/darksign) out of a boss fight too early after having killed the boss, you may not have defeated the boss if its rewards are not in your inventory after boning out.
...
- Follow the notes as accurately as you can (getting safety bonfires is fine, also feel free to skip using [Red Tearstone Ring](https://darksouls2.wikidot.com/red-tearstone-ring) (when applicable) to start with). Don't level more than you should. Try not to lose large amounts of souls since there is no way to get them back.
...
- Make splits. Download a program like [**Livesplit**](https://livesplit.org/) or [**WSplit**](https://www.mediafire.com/download/x6e6g8d0m5daa3q/WSplit+1.5.2.zip) and setup your splits. It doesn't matter how bad they are in your first run.
- [Dark Souls II All Bosses no DLC tutorial](https://youtu.be/Ybs11sTwerM) by Noobest on YouTube:
- [Dark Souls II parrywalk skips](https://www.youtube.com/playlist?list=PLzMUHHzrjZNh_eHHbh6YSiEIUeXHQfmFI) by Noobest on YouTube
