...
- The initial skip was found by [**ThisHEX**](https://youtube.com/channel/UCgmq4h643S5tc6_qPYdUIgw).
- The skip is confirmed working on `Version 1.12`

## Tutorial Video

Angel Skip Tutorial by [**Distortion2**](https://youtube.com/watch?v=E2zVG3u38HI).

Angel Skip Tutorial by [**ThisHEX**](https://youtube.com/watch?v=KVCGaX-x_QIPYdUIgw).

Angel Skip Tutorial by [**Luc1**](https://youtube.com/watch?v=bLNfib1adIY).

Angel Skip Tutorial by [**Ginz**](https://youtube.com/watch?v=ducUr6e0Xsg).
