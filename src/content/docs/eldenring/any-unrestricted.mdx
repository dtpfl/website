---
title: Any% Unrestricted
hidden: false
---
[**Elden Ring**](/eldenring)  **Any% Unrestricted** is a speedrun category in which the player tries to complete the game as fast as possible with no restrictions about game version or what glitches are used.

## Category Specific Rules

Any% Unrestricted - Reach the credits of the game.
